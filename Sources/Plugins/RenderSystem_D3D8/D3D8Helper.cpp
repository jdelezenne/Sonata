...
D3DCOLOR D3D8Helper::MakeD3DColor(const Color32& value)
{
	return D3DCOLOR_COLORVALUE(
		value.r, value.g, value.b, value.a);
}

D3DXCOLOR D3D8Helper::MakeD3DXColor(const Color32& value)
{
	return D3DXCOLOR(
		value.r, value.g, value.b, value.a);
}

D3DXMATRIX D3D8Helper::MakeD3DXMatrix(const Matrix4& value)
{
	// Transpose matrix
	D3DXMATRIX result;
...
D3DFOGMODE D3D8Helper::GetFogMode(FogMode value)
{
	D3DFOGMODE result;
	switch (value)
	{
...
D3DTEXTUREADDRESS D3D8Helper::GetAddressMode(TextureAddressMode value)
{
...
D3DTEXTUREFILTERTYPE D3D8Helper::GetFilterType(TextureFilterType value)
{
...
D3DCMPFUNC D3D8Helper::GetCmpFunction(ComparisonFunction function)
{
	D3DCMPFUNC result;
	switch (function)
	{
...
D3DSTENCILOP D3D8Helper::GetStencilOp(StencilOperation value)
{
	D3DSTENCILOP result;
	switch (value)
	{
...
D3DBLEND D3D8Helper::GetBlendMode(BlendMode value)
{
	D3DBLEND result;
	switch (value)
	{
...
D3DBLENDOP D3D8Helper::GetBlendOperation(BlendOperation value)
{
	D3DBLENDOP result;
	switch (value)
	{
...
D3DTEXTUREOP D3D8Helper::GetTextureOperation(TextureOperation value)
{
	switch (value)
	{
...
DWORD D3D8Helper::GetTextureArgument(TextureArgument value)
{
	switch (value)
	{
	...
	case TextureArgument_Constant: return D3DTA_DIFFUSE;
...
DWORD D3D8Helper::GetTextureCoordinateMode(TextureCoordinateMode value)
{
	switch (value)
	{
	...
	case TextureCoordinateMode_SphereMap:
	default: return D3DTSS_TCI_PASSTHRU;
	}
}

D3DTEXTURETRANSFORMFLAGS D3D8Helper::GetTextureTransform(TextureTransform value)
{
	switch (value)
	{
...
DWORD D3D8Helper::GetVertexFormatType(VertexFormatConstants value)
{
	DWORD result;
	switch (value)
	{
	case VertexFormat_Float1: result = D3DVSDT_FLOAT1; break;
	case VertexFormat_Float2: result = D3DVSDT_FLOAT2; break;
	case VertexFormat_Float3: result = D3DVSDT_FLOAT3; break;
	case VertexFormat_Float4: result = D3DVSDT_FLOAT4; break;
	case VertexFormat_Color: result = D3DVSDT_FLOAT4; break;
	case VertexFormat_UByte4: result = D3DVSDT_UBYTE4; break;
	case VertexFormat_Short2: result = D3DVSDT_SHORT2; break;
	case VertexFormat_Short4: result = D3DVSDT_SHORT4; break;
	default: result = 0;
	}
...
DWORD D3D8Helper::GetVertexSemantic(VertexSemanticConstants value)
{
	DWORD result;
	switch (value)
	{
	case VertexSemantic_Position: result = D3DVSDE_POSITION; break;
	case VertexSemantic_BlendWeight: result = D3DVSDE_BLENDWEIGHT; break;
	case VertexSemantic_BlendIndices: result = D3DVSDE_BLENDINDICES; break;
	case VertexSemantic_Normal: result = D3DVSDE_NORMAL; break;
	case VertexSemantic_PSize: result = D3DVSDE_PSIZE; break;
	case VertexSemantic_Tangent: result = D3DVSDE_TEXCOORD1; break;
	case VertexSemantic_Binormal: result = D3DVSDE_TEXCOORD1; break;
	case VertexSemantic_TesselateFactor: result = D3DVSDE_TEXCOORD1; break;
	case VertexSemantic_PositionTransformed: result = D3DVSDE_TEXCOORD1; break;
	case VertexSemantic_Color: result = D3DVSDE_DIFFUSE; break;
	case VertexSemantic_Fog: result = D3DVSDE_TEXCOORD1; break;
	case VertexSemantic_Depth: result = D3DVSDE_TEXCOORD1; break;
	case VertexSemantic_Sample3: result = D3DVSDE_TEXCOORD1; break;
	default: result = 0;
	}
...
D3DFORMAT D3D8Helper::GetFormat(PixelFormat value)
{
...
int32 D3D8Helper::GetColorChannelBits(D3DFORMAT format)
{
	switch (format)
	{
	case D3DFMT_R8G8B8:
...
int32 D3D8Helper::GetAlphaChannelBits(D3DFORMAT format)
{
	switch (format)
	{
		case D3DFMT_R8G8B8:
...
int32 D3D8Helper::GetDepthBits(D3DFORMAT format)
{
	switch (format)
	{
		case D3DFMT_D32:
...
int32 D3D8Helper::GetStencilBits(D3DFORMAT format)
{
	switch (format)
	{
		case D3DFMT_D16_LOCKABLE:
...
int32 D3D8Helper::GetBitDepth(D3DFORMAT format)
{
	switch (format)
	{
	case D3DFMT_R8G8B8:
