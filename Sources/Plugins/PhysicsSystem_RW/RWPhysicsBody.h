...
#ifndef _SE_RWPHYSICSBODY_H_
#define _SE_RWPHYSICSBODY_H_
...
/** RW Body. */
class RWPhysicsBody : public Physics::IBody
{
public:
	RWPhysicsBody(RWPhysicsScene* scene, const BodyDescription& desc);
	virtual ~RWPhysicsBody();
