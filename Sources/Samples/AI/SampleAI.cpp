...
bool GameCore::CreateRenderSystem()
{
	...
	_MainWindow->Create(NULL, "AI Sample", 800, 600, false);
...
void GameCore::CreateWorld()
{
	...
	String tileset = FileSystem::Instance()->GetFullPath("AI\\AW\\AWTileset.xml", true);
	_World->LoadTileset(tileset);
}

void GameCore::AddEntity(GameEntity* entity)
{
	_GameUI->AddEntity(entity);
	_World->AddEntity(entity);
}

void GameCore::RemoveEntity(GameEntity* entity)
{
	_GameUI->RemoveEntity(entity);
